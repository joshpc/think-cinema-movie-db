 ...
 *
 * View and edit your roles and permissions in the Gadget editor at https://tc-movie-db.gadget.app/edit/settings/permissions
 */
export const permissions: GadgetPermissions = {
  ...
  roles: {
    ...
    "Developer Role": {
      ...
      actions: {
        bulkUploadActorsAndCredits: true,
      },
    },
    "Testing Role": {
      storageKey: "EY6l-6bQA3MG",
    },
  },
};
